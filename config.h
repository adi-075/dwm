...
static Key keys[] = {
    ...
    {MODKEY, XK_BackSpace, spawn, SHCMD(TERMINAL "-e sysact")},
    ...
    {MODKEY, XK_F12, spawn,
     SHCMD("remaps & notify-send \\\"⌨️ Keyboard remapping...\\\" \\\""
           "Re-running keyboard defaults for any newly plugged-in keyb"
           "oards.\\\"")},
